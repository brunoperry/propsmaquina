...
export default class Gradients {
  constructor(minYVert, midYVert, maxYVert) {
    ...
    this.lightAmt[0] =
      this.saturate(minYVert.getNormal().dot(lightDir)) * 0.9 + 0.2;
    this.lightAmt[1] =
      this.saturate(midYVert.getNormal().dot(lightDir)) * 0.9 + 0.2;
    this.lightAmt[2] =
      this.saturate(maxYVert.getNormal().dot(lightDir)) * 0.9 + 0.2;
  ...
  calcXStep(values, minYVert, midYVert, maxYVert, oneOverDx) {
    return (
      ((values[1] - values[2]) * (minYVert.get(1) - maxYVert.get(1)) -
        (values[0] - values[2]) * (midYVert.get(1) - maxYVert.get(1))) *
      oneOverDx
    );
  }
  //floats[], vertex, vertex, vertex, float
  calcYStep(values, minYVert, midYVert, maxYVert, oneOverDy) {
    return (
      ((values[1] - values[2]) * (minYVert.get(0) - maxYVert.get(0)) -
        (values[0] - values[2]) * (midYVert.get(0) - maxYVert.get(0))) *
      oneOverDy
    );
  }
  ...
  // getTexCoordXXStep() {
  //   return this.texCoordXXStep;
  // }
  // getTexCoordXYStep() {
  //   return this.texCoordXYStep;
  // }
  // getTexCoordYXStep() {
  //   return this.texCoordYXStep;
  // }
  // getTexCoordYYStep() {
  //   return this.texCoordYYStep;
  // }
  ...
  // getLightAmtXStep() {
  //   return this.lightAmtXStep;
  // }
  // getLightAmtYStep() {
  //   return this.lightAmtYStep;
  // }
}
