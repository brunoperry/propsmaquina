class Edge {
  constructor(gradients, minYVert, maxYVert, minYVertIndex) {
    ...
    this.texCoordXStep =
      gradients.getTexCoordXYStep() +
      gradients.getTexCoordXXStep() * this.xStep;
    ...
    this.texCoordYStep =
      gradients.getTexCoordYYStep() +
      gradients.getTexCoordYXStep() * this.xStep;
    ...
    this.oneOverZStep =
      gradients.getOneOverZYStep() + gradients.getOneOverZXStep() * this.xStep;
    ...
    this.depthStep =
      gradients.getDepthYStep() + gradients.getDepthXStep() * this.xStep;
    ...
    this.lightAmtStep =
      gradients.getLightAmtYStep() + gradients.getLightAmtXStep() * this.xStep;
  }
  ...
  get toString() {
    return `
            getYStart: ${this.getYStart()}
            getYEnd: ${this.getYEnd()}
            getX: ${this.getX()}
            getTexCoordX: ${this.getTexCoordX()}
            getTexCoordY: ${this.getTexCoordY()}
            getOneOverZ: ${this.getOneOverZ()}
            getDepth: ${this.getDepth()}
            getLightAmt: ${this.getLightAmt()}
        `;
  }
