class Vertex {
    ...
    perspectiveDivide() {
        ...
        const v = new Vec4(this.pos.getX() / this.pos.getW(),
    ...
    triangleAreaTimesTwo(b, c) {
        ...
        const x1 = b.get(0) - this.pos.getX();
        const y1 = b.get(1) - this.pos.getY();

        const x2 = c.get(0) - this.pos.getX();
        const y2 = c.get(1) - this.pos.getY();
